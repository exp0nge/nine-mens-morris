...
function alertIfWinner() {
    if (_common.PURPLE_PLAYER.PLACED <= 2 || _common.YELLOW_PLAYER.PLACED <= 2) {
        clearElement(turnPromptText);
        clearElement(turnText);
        document.getElementById("phaseText").innerHTML = "WINNER " + (_common.PURPLE_PLAYER.AVAILABLE <= 0 ? "YELLOW" : "PURPLE");
